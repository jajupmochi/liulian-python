...
iTransformer inverts the typical approach by applying attention across variates
rather than time steps, achieving better performance on multivariate forecasting.
"""
